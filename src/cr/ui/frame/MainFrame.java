...
public final class MainFrame extends JFrame {
    ...
    private final Image trayImage = ImageIO.read(getClass().getClassLoader().getResource("res/img/TrayIcon.png"));
    ...
    private MainFrame() throws Exception {
        ...
        setIconImage(ImageIO.read(getClass().getClassLoader().getResource("res/img/Img.png")));
//        init frame size
...
//        add trayIcon
        if (SystemTray.isSupported()) {
            trayIcon = new TrayIcon(trayImage, LocalEnum.TITTLE, new IconPopMenu());
