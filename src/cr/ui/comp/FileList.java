...
public final class FileList extends JPanel {
    ...
    private FileList() throws IOException {
        ...
        title.setIcon(new ImageIcon(ImageIO.read(getClass().getClassLoader().getResource("res/icon/upload.png")).getScaledInstance(20,20,Image.SCALE_SMOOTH)));
    ...
    public void addFile(FileInfo info) {
        ...
        repaint();
        count++;
//        if (pane.getY()+count*22>getHeight())
//            setSize(getHeight(),pane.getY()+count*22);
    }

    private static final class FileButton extends JButton {
        public FileButton(FileInfo file) {
            ...
            addActionListener(e -> Client.getClient().download(file.id));
        }
    }
